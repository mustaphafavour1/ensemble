...
export const nivoDarkTheme = {
  ...
  text: { fill: neutral[400], fontSize: 9.5, fontFamily: "var(--font-sans)" },
  axis: {
    domain: { line: { stroke: neutral[800], strokeWidth: 1 } },
    ticks: {
      line: { stroke: neutral[800], strokeWidth: 1 },
      text: { fill: neutral[500], fontSize: 9 },
    },
    legend: { text: { fill: neutral[400], fontSize: 10 } },
  },
  grid: { line: { stroke: neutral[800], strokeWidth: 1 } },
  legends: { text: { fill: neutral[300], fontSize: 9.5 } },
  tooltip: {
    container: {
