...
const SEED_ITEMS: { title: string; description: string; category: BacklogCategory; estimatedImpact: string; flaggedByAi: boolean }[] = [
  ...
  { title: "Right-size Solis Vision serving replicas", description: "Current replica count assumes peak load 24/7; scale to actual traffic curve.", category: "Cost", estimatedImpact: "+$41K/mo savings", flaggedByAi: true },
  ...
  { title: "Retire the 3.5 generation's dedicated capacity", description: "Traffic has fallen enough to fold 3.5 serving into the shared 4.1 pool.", category: "Cost", estimatedImpact: "+$18K/mo savings", flaggedByAi: true },
  ...
  { title: "Cache repeated Solis Code completions", description: "Boilerplate completions (imports, common patterns) repeat heavily across requests.", category: "Cost", estimatedImpact: "+$9K/mo savings", flaggedByAi: true },
  ...
  { title: "Sunset unused regional replicas for Vision 1.0", description: "Deprecated model still holds capacity reservations in two regions.", category: "Cost", estimatedImpact: "+$6K/mo savings", flaggedByAi: true },
];
